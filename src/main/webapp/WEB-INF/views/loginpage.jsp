...
<nav class="navbar navbar-default navbar-doublerow navbar-trans navbar-fixed-top">
  ...
  <nav class="navbar navbar-down">
    <div class="container">
      ...
      <li><a href="signup" class="text-white">New User? Register</a></li> 
        </ul>
	...
	var textfield1 = $("input[name=password]");
	            ...
	            /* $('button[type="submit"]').click(function(e) {
	                ...
	                if (textfield.val()!= "" || textfield1.val()!="" ) {
	                    ...
	                    //show avatar
	                    $(".avatar").css({
	                        "background-image": "url('http://res.cloudinary.com/dcggaci79/image/upload/v1510909988/User_Person_Avatar_Profile_Account_Login_Man-512_j4wmhl.png')"
	                    });
	                }
