...
<form:form method="post" action="UpdateGenreFromDB" modelAttribute="Genre" style="margin: auto; width: 80%; text-align: center;">
	...
	<form:textarea path="Description" class="form-control" placeholder="Genre Description"/>
